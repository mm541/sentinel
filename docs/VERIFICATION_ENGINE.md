...
3. **Comparison:** It diffs collections of drives, RAM DIMMs, MAC arrays, and GPU arrays tracking exactly what was inserted (rogue PCI devices) or removed (stripped RAM).
